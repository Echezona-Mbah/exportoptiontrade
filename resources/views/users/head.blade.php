  ...
  >
          ...
          >
            <li class="nav-item" style="background-color: #298fa6">
              ...
              >
                ...
                <span class="text">Kizito </span>
              </button>
              <div class="dropdown-menu">
                <a class="dropdown-item" href="edit_account.html">
                  <i class="fas fa-user"></i>
                  Profile
                </a>
                <a class="dropdown-item" href="deposit.html">
                  <i class="fas fa-coins"></i>
                  Deposit
                </a>
                <a class="dropdown-item" href="withdraw.html">
                  <i class="fas fa-wallet"></i>
                  Withdraw
                </a>
                <a class="dropdown-item" href="earnings.html">
    ...
    <div class="sidebar-left" style="background-color: #298fa6">
        ...
        <div class="list-unstyled btn-group" style="background-color: #298fa6">
          ...
          >
            ...
            <span class="media-body" style="background-color: #298fa6">
              <span class="mt-0 mb-1">Kizito </span>
      ...
      >
        ...
        <li class="nav-item">
          <a href="referals.html" class="nav-link">
            <i class="fas fa-chart-pie"></i>
            Referals
          </a>
        </li>
        <li class="nav-item">
          <a href="referallinks.html" class="nav-link">
        ...
        <li class="nav-item">
          <a href="edit_account.html" class="nav-link">
    ...
    <div class="wrapper-content">
     ...
     >
       ...
       >
        ...
        <div class="row mgt5">
          <div
            class="col-8 col-sm-8 col-md-8 col-lg-8 col-xl-4"
            style="background-color: #298fa6"
          >
            <div class="activity-block warning">
              ...
              <i
                ...
                class="bg-icon text-center fas fa-dollar-sign"
              ></i>
            </div>
          </div>
          <div
          ...
          >
            <div class="activity-block info">
              ...
              <i
                style="margin-top: -12px"
                class="bg-icon text-center fas fa-chart-bar"
              ></i>
            </div>
          </div>
          <div
          ...
          >
            <div class="activity-block primary">
              ...
              <i
                style="margin-top: -12px"
                class="bg-icon text-center fas fa-users"
              ></i>
            </div>
          </div>
          ...
          >
            <div class="activity-block danger">
                  ...
                  <h5 class="font-weight-bold">
                    <span class="">
                      <i
                        ...
                        class="fas fa-check-circle blink_me"
                        >Verified</i
                      >
                    </span>
                  </h5>
              ...
              <i
                style="margin-top: -12px"
                class="bg-icon text-center fas fa-address-card"
              ></i>
            </div>
          </div>
        </div>
