...
<!-- Mirrored from altcoinvests.com/expertoption-trade.com/forgot_password by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 30 Jan 2024 08:55:18 GMT -->
...
<link href="{{asset('css/mee.css')}}" rel="stylesheet">
<link href="{{asset('css/animates.css')}}" rel="stylesheet">
...
<li><span class="icon fa fa-phone-volume"></span> <a href="#"></a></li>
<li><span class="icon fa fa-clock"></span> Days Online: 1100</li>
</ul>
</div>
...
<div class="btn-box">
<a href="signup.html" class="theme-btn btn-style-two"><span class="btn-title">Join Us</span></a>
</div>
</div>
</div>
</div>
...
<div class="logo"><a href="index-2.html"><img style="width:190px; height:80px;" src="{{asset('app/images/logo2.png')}}" alt="" title=""></a></div>
</div>
...
<li class="dropdown"><a href="affiliate.html">Affiliate</a>
</li>
<li class="dropdown"><a href="faq.html">FAQs</a>
</li>
...
<script type="text/javascript" src="{{asset('../../translate.google.com/translate_a/elementa0d8.js?cb=googleTranslateElementInit')}}"></script>
</header>
...
<a href="index-2.html" title=""><img src="{{asset('images/logo.png')}}" alt="" title=""></a>
</div>
...
<nav class="menu-box">
<div class="nav-logo"><a href="index-2.html"><img style="width:190px; height:80px;" src="app/images/logo2.png" alt="" title=""></a></div>
<ul class="navigation clearfix"></ul>
<div class="social-links">
<ul class="clearfix">
<li><a href="#"><span class="fa fa-facebook-square"></span></a></li>
<li><a href="#"><span class="fa fa-twitter-square"></span></a></li>
<li><a href="#"><span class="fa fa-dribbble-square"></span></a></li>
...
<div class="logo pull-left">
<a href="index-2.html" title=""><img src="{{asset('images/logo-small.png')}}" alt="" title=""></a>
</div>
...
<div class="close-btn"><span class="icon flaticon-close-1"></span></div>
<nav class="menu-box">
<div class="nav-logo"><a href="index-2.html"><img src="{{asset('images/nav-logo.png')}}" alt="" title=""></a></div>
<ul class="navigation clearfix"></ul>
<div class="social-links">
<ul class="clearfix">
<li><a href="#"><span class="fa fa-facebook-square"></span></a></li>
...
<input type="email" name=email value='{{$request->email}}':value="old('email', $request->email)"placeholder="Enter Email">
</div>
...
<div class="col-lg-6 col-md-12 col-sm-12 form-group">
        <input type="password" name=password_confirmation value='' placeholder="Enter password_confirmation">
        <x-input-error :messages="$errors->get('password_confirmation')" class="mt-2" />
 </div>
<div id="result"></div>
<div class="col-lg-12 col-md-12 col-sm-12 form-group">
<button class="theme-btn btn-style-two" id="btn" type="submit" value="Request Link"><span class="btn-title">Request Link</span></button>
</div>
</div>
</form>
</div>
...
<div class="text">
<script src="{{asset('../../widgets.coingecko.com/coingecko-coin-ticker-widget.js')}}"></script>
...
<script src="{{asset('js/scrollbar.js')}}"></script><script src="js/script.js"></script>

<script src="{{asset('https://maps.googleapis.com/maps/api/js?key=AIzaSyDcaOOcFcQ0hoTqANKZYz-0ii-J0aUoHjk')}}"></script>
<script src="{{asset('js/map-script.html')}}"></script>
</body>
