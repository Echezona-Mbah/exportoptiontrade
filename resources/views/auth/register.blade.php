...
<!-- Mirrored from altcoinvests.com/expertoption-trade.com/signup by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 30 Jan 2024 08:54:41 GMT -->
...
<div class="logo"><a href="index-2.html"><img style="width:190px; height:60;" src="app/images/logo2.png" alt="" title=""></a></div>
</div>
...
<div class="auto-container">
<div class="sec-title">
<span class="title">Type Your information</span>
<h2>Sign Up Here</h2>
</div>
<style>
...
<x-text-input id="name" class="block mt-1 w-full" type="text" placeholder="Enter First Name" name="name" :value="old('name')"  />
</div>
<div class="col-lg-6 col-md-12 col-sm-12 form-group">
<x-text-input id="name" class="block mt-1 w-full" type="text" placeholder="Enter Last Name" name="lastname" :value="old('lastname')"  />
</div>
<div class="col-lg-6 col-md-12 col-sm-12 form-group">
 <x-text-input id="email" class="block mt-1 w-full" type="email"  placeholder="Enter Email" name="email" :value="old('email')" />
</div>
<div class="col-lg-6 col-md-12 col-sm-12 form-group">
<x-text-input id="wallet" class="block mt-1 w-full" type="text" placeholder="Your Bitcoin Wallet Address" name="wallet" :value="old('wallet')"  />
</div>

<div id="result"></div>

<div class="col-lg-6 col-md-12 col-sm-12 form-group">
<x-text-input id="password" class="block mt-1 w-full" type="password" name="password" placeholder="Enter Password"/>
</div>

<div class="col-lg-6 col-md-12 col-sm-12 form-group">
<x-text-input id="quesion" class="block mt-1 w-full" type="text" placeholder="Secret Question" name="quesion" :value="old('quesion')"  />
</div>

<div class="col-lg-6 col-md-12 col-sm-12 form-group">
<input type=checkbox name=agree value=1 required> I agree with <a href="rules.html">Terms and conditions</a>
</div>
<div class="col-lg-12 col-md-12 col-sm-12 form-group">
<button class="theme-btn btn-style-two" type="submit" id="btn" value="Register">
...
<!-- Mirrored from altcoinvests.com/expertoption-trade.com/signup by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 30 Jan 2024 08:54:53 GMT -->
</html>
